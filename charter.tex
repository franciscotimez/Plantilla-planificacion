...
\multicolumn{1}{|c|}{\cellcolor[HTML]{9B9B9B}} &
  ...
  Cliente \\ \cline{3-5} 
\rowcolor[HTML]{9B9B9B} 
\multicolumn{1}{|c|}{\multirow{-2}{*}{\cellcolor[HTML]{9B9B9B}código WBS}} &
...
\hline
\rowcolor[HTML]{9B9B9B} 
\multicolumn{6}{|c|}{\cellcolor[HTML]{9B9B9B}PLAN DE COMUNICACION DEL PROYECTO} \\ \hline
\rowcolor[HTML]{9B9B9B} 
...
Encargado: \authorname . 
	...
	\item Se avaluará los tiempos de ejecución real de las tareas junto con los planteados en el diagrama de Gantt.
	\end{itemize}
...
Encargado: \authorname .
	...
	\item En caso de surgir problemas se evaluará la idea original, porqué no resultó adecuada, y la solución ejecutada.
	\end{itemize}
